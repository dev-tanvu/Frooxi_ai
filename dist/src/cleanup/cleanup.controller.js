...
let CleanupController = class CleanupController {
    ...
    async triggerCleanup(type = 'daily') {
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], CleanupController.prototype, "triggerCleanup", null);
exports.CleanupController = CleanupController = __decorate([
    (0, common_1.Controller)('cleanup'),
    (0, common_1.UseGuards)(api_key_guard_1.ApiKeyGuard),
    __metadata("design:paramtypes", [database_cleanup_service_1.DatabaseCleanupService])
], CleanupController);
